...
private:
    ...
    Eigen::Vector3d result_delta_p = Eigen::Vector3d::Zero();
    Eigen::Quaterniond result_delta_q = Eigen::Quaterniond::Identity();
    Eigen::Vector3d result_delta_v = Eigen::Vector3d::Zero();
};
