...
class LidarEdgeCostFn : public ceres::SizedCostFunction<3, 4, 3> {
	public:
		...
		// Eigen::Quaternion<double> q = parameters[0][0];
		// Eigen::Matrix<double, 3, 1> t = parameters[0][1];
		...
		// bool res = ComputeResidual(q, t, residuals);
		...
		// bool ComputeResidual(const Eigen::Quanternion *q, 
